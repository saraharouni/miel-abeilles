...
**L'ensemble des tests que j'ai réalisé se trouvent dans le notebook du répertoire. J'ai également testé l'algorithme de Dijkstra *(C'est un algorithme utilisé en informatique pour trouver le plus court chemin entre deux nœuds dans un graphe pondéré.*) afin de comparer mes résultats obtenus avec mon algorithme génétique.**  
